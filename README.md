...
Design authority: `agentops-engine/docs/ARCHITECTURE.md` (§5.1 cluster base, §5.7 multi-product topology, §5.8 repo layout). Bootstrap procedure: [docs/BOOTSTRAP.md](docs/BOOTSTRAP.md).
